...
class DatabaseInfo {
    ...
    companion object {
        ...
        val SQL_UPDATE_TASK_ADD_ON_SUCCESS_COMMAND = "ALTER TABLE ${Task.TABLE_NAME} ADD COLUMN ${Task.COLUMN_NAME_ON_SUCCESS_COMMAND} TEXT DEFAULT ''"
        val SQL_UPDATE_TASK_ADD_ON_FAILURE_COMMAND = "ALTER TABLE ${Task.TABLE_NAME} ADD COLUMN ${Task.COLUMN_NAME_ON_FAILURE_COMMAND} TEXT DEFAULT ''"
